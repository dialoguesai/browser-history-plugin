...
/** Bumped when app_id or redirect contract changes; clears stale redirect-setup cache in storage. */
export const DIALOGUES_CONNECT_SETUP_KEY = 'browser-history-plugin';
...
/** Skip click/highlight/video content tracking; navigation visits still logged in background.js */
export const DEFAULT_INTERACTION_SKIP_DOMAINS = [
    'meet.google.com',
    'zoom.us',
    'zoom.com',
    'teams.microsoft.com',
